                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="form-control" id="flujo_personas_select">
                                        ...
                                        <?php $__currentLoopData = $personas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($persona->id); ?>" data-apellido="<?php echo e($persona->apellido); ?>" data-nombres="<?php echo e($persona->nombres); ?>">
                                                <?php echo e($persona->apellido); ?>, <?php echo e($persona->nombres); ?>

                                                <?php if($persona->dni): ?>
                                                    (<?php echo e($persona->dni); ?>)
                                                <?php endif; ?>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="form-control" id="flujo_tipos_actores_select">
                                        ...
                                        <?php $__currentLoopData = $tiposActores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($tipo->id); ?>" data-descripcion="<?php echo e($tipo->descripcion); ?>">
                                                <?php echo e($tipo->descripcion); ?>

                                                <?php if($tipo->observaciones): ?>
                                                    (<?php echo e(substr($tipo->observaciones, 0, 30)); ?>...)
                                                <?php endif; ?>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
function actualizarPanelPersonas() {
    ...
    const personaBaseUrl = '<?php echo e(url("/internal/personas")); ?>/';
    const tipoActorBaseUrl = '<?php echo e(url("/internal/tipos-actores")); ?>/';
...
<?php /**PATH /var/www/html/resources/views/internal/flujos/create.blade.php ENDPATH**/ ?>