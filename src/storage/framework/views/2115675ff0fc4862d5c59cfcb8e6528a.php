...
<?php $__env->startSection('page_title', 'Gestión de Procesos'); ?>
        ...
        <div class="card mb-3">
            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                ...
                <div class="ml-auto d-flex">
                    <a href="<?php echo e(route('internal.procesos.create')); ?>" class="btn btn-secondary btn-sm">
                    ...
                    <div class="col-auto d-flex align-items-center">
                        ...
                        <select class="form-control form-control-sm" id="filterCriticidad" style="flex:1; padding:.25rem .5rem; height: calc(1.5em + .5rem + 2px);">
                            ...
                            <?php $__currentLoopData = $criticidadesProceso; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criticidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($criticidad->id); ?>"><?php echo e($criticidad->descripcion); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-auto d-flex align-items-center">
...
function loadProcesos(page = 1) {
    ...
    $.ajax({
        url: '<?php echo e(route("internal.procesos.index")); ?>',
        method: 'GET',
        data: filters,
        dataType: 'json',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/internal/procesos/index.blade.php ENDPATH**/ ?>