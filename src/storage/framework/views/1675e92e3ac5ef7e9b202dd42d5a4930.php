...
<?php $__env->startSection('page_title', 'Gestión de Personas'); ?>
    ...
    <div class="col-12">
        ...
        <div class="card mb-3">
            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('internal.personas.create')); ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <div id="emptyStateContainer" style="display: none; text-align: center; padding: 40px;">
                    ...
                    <a href="<?php echo e(route('internal.personas.create')); ?>" class="btn btn-secondary btn-sm mt-2">
                        <i class="fas fa-plus mr-1"></i> Nueva Persona
                    </a>
                </div>
            </div>
...
function loadPersonas(page) {
    ...
    $.ajax({
        url: '<?php echo e(route("internal.personas.index")); ?>',
        method: 'GET',
        data: filters,
        dataType: 'json',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/internal/personas/index.blade.php ENDPATH**/ ?>