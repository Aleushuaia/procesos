...
@section('title', 'Gestion de accceso')
@section('page_title', 'Gestion de accceso')
                                ...
                                @forelse($roles as $role)
                                    <tr data-role-id="{{ $role->id }}">
                                        ...
                                        <td class="text-center">
                                            <span class="badge badge-success user-count-{{ $role->id }}">
                                                {{ $role->users()->count() }}
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <button class="btn btn-xs btn-info btnEditRole" data-role-id="{{ $role->id }}" title="Editar permisos">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            @if(!in_array($role->name, ['administrador', 'agente']))
                                                <button class="btn btn-xs btn-danger btnDeleteRole" data-role-id="{{ $role->id }}" title="Eliminar rol">
                            ...
                            <tbody>
                                @forelse($users as $user)
                                    <tr data-user-id="{{ $user->id }}">
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-xs btn-primary btnAssignRole" data-user-id="{{ $user->id }}" title="Asignar rol">
...
@section('scripts')
<script>
    window.PERMISSIONS_BY_MODULE = @json($permissionsByModule ?? []);
</script>
