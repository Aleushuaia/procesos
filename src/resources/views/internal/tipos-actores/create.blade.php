...
@section('page_title', 'Nuevo Tipo de Actor')
@section('breadcrumb')<li class="breadcrumb-item"><a href="{{ route('internal.tipos-actores.index') }}">Tipos</a></li><li class="breadcrumb-item active">Nuevo</li>@endsection
@section('content')
