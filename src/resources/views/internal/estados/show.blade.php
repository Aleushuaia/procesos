...
<div class="row">
    <div class="col-md-8">
        <div class="form-card">
            <div class="mb-3"><label class="text-muted small">Descripción</label><p>Descripción del estado</p></div>
            <div class="mt-4">
                <a href="{{ route('internal.estados.edit', 1) }}" class="btn btn-primary-pro"><i class="fas fa-pencil-alt mr-2"></i> Editar</a>
