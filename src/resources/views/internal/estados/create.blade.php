...
<div class="row">
    <div class="col-md-8">
        <form action="{{ route('internal.estados.store') }}" method="POST" class="form-card">
            @csrf
            ...
            <div class="form-group mt-4">
                <button type="submit" class="btn btn-primary-pro"><i class="fas fa-save mr-2"></i> Guardar</button>
